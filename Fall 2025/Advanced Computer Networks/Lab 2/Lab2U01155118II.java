...
public class Lab2U01155118II {
    ...
    // change virtual time and real time using backlog weight.
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (numberOfDepartedPackets < numberOfPackets) {
            ...
            while (!arrivalEvents.isEmpty() &&
                ...
                // go/set clock to arrival instant
            ...
            if (packetInProgress == null) {
                ...
                // if still no eligible packets, we need to change clock time.
                if (eligibleDepartures.isEmpty()) {
                    ...
                    if (nextArrivalTime < clock.realTime + boundaryDelta - EPS) {
                        // change clock to next arrival time
                ...
                while (!eligibleDepartures.isEmpty()) {
                    ...
                    if (candidatePacket.virtualStartTime <= clock.virtualTime + EPS) {
                        ...
                        if (selectedPacket == null ||
                                ...
                                (Math.abs(candidatePacket.virtualFinishTime - selectedPacket.virtualFinishTime) < EPS &&
